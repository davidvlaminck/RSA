...
FOR n IN assets
  ...
  FOR other, rel IN ANY n voedt_relaties
    FILTER (
      (n.assettype_key == ls_key AND other.assettype_key != lsdeel_key) OR
      (n.assettype_key == hs_key AND other.assettype_key != hsdeel_key)
    )
    RETURN {
      uuid: n._key,
      typeURI: n.typeURI,
      naampad: n.AIMNaamObject_naampad,
      naam: n.AIMNaamObject_naam,
      isActief: n.AIMDBStatus_isActief,
      asset2_uuid: other._key,
      asset2_typeURI: other.typeURI,
      asset2_naampad: other.AIMNaamObject_naampad,
