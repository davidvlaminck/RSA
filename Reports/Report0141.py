...
class Report0141(BaseReport):
    def init_report(self) -> None:
        self.report = DQReport(name='report0141',
                               ...
                               persistent_column='Q',
                               link_type='eminfra',
                               excel_filename='[RSA] Bijhorende assets hebben een verschillende toezichtshouder (assettype = overige).xlsx',
                               )
