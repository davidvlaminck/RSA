...
SELECT a.uuid, failovertypes.naam, b.uuid as legacy_uuid, b.naampad, b.toestand, assettypes."label" AS legacy_afkorting, 
...
FROM failovertypes 
	...
	LEFT JOIN assets b ON b.uuid  = assetrelaties.doeluuid AND b.actief = TRUE
