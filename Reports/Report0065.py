...
class Report0065(BaseReport):
    def init_report(self) -> None:
        self.report = LegacyHistoryReport(name='report0065',
                                          title="Detailrapport invulgraad legacy installaties Telematica",
...
records AS ( 
	...
	WHERE assets.actief = TRUE AND assettypes.uri NOT LIKE 'https://grp%' AND assettypes.uri NOT LIKE 'https://wegen%' AND toezichtgroepen.referentie = 'EMT_TELE' ) 
SELECT *
FROM records
