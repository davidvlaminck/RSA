...
class Report0147(BaseReport):
    def init_report(self) -> None:
        self.report = DQReport(name='report0147',
                               title='Dubbele bomen (Vlaams-Brabant)',
                               spreadsheet_id='16Ge-0TnI9AsAv1bENiOX0E49FWS_sB7NmOL4Z4CXEJc',
                               datasource='PostGIS',
                               persistent_column='T',
                               excel_filename='[RSA] Dubbele bomen (Vlaams-Brabant).xlsx',
                               )
...
, cte_boom AS (
	...
	where
		l.x > 116098 and l.x < 207630 and l.y > 153058 and l.y < 193542
		and
