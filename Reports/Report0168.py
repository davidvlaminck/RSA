...
class Report0168(BaseReport):
    def init_report(self) -> None:
        self.report = DQReport(name='report0168',
                               title='Ontbrekende gegevens installaties EW Overige',
                               spreadsheet_id='1XdDDjAwQJA9XDIm3hYMcTmNOn1SeRbHQQ8mSgX-FG8Y',
                               datasource='PostGIS',
                               persistent_column='K',
