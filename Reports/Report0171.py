    ...
    def init_report(self):
        ...
        with cte_lookup_table ("assettype", "assetnaam", "regexp_pattern") as (
            values
                ...
                , ('615356ae-64eb-4a7d-8f40-6e496ec5b8d7'::uuid, 'galgpaal', '^(A|C|G|WO|WW)[0-9]{4}\.T\d*$')
                , ('556061ca-ecd8-42c7-81fd-9163930f080b'::uuid, 'montagekast', '^(A|C|G|WO|WW)[0-9]{4}\.T\d*.MK\d*$')
                ...
                , ('556061ca-ecd8-42c7-81fd-9163930f080b'::uuid, 'montagekast', '^(A|C|G|WO|WW)[0-9]{4}\.C\d*\.MK\d*$')
        ...
        --		, (''::uuid, 'LED-driver', '')
        --		, (''::uuid, 'armatuurcontroller', '')
                -- VVOP (Verlichte Voetgangersoversteekplaats)
        --		, (''::uuid, 'galgpaal', '')
        --		, (''::uuid, 'montagekast', '')
        --		, (''::uuid, 'VVOP-verlichtingstoestel', '')
        --		, (''::uuid, 'VFOP-verlichtingstoestel', '')
        ...
        , cte_assets as (
            ...
            --	and
            --	regexp_like(a.naam, lookup.regexp_pattern) is true
