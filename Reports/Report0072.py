...
class Report0072(BaseReport):
    def init_report(self) -> None:
        self.report = LegacyHistoryReport(name='report0072',
                                          title="Detailrapport invulgraad legacy installaties EW West-Vlaanderen",
                                          spreadsheet_id='1bZWK57v6rRypO6tptEtGQl2L-xZDLE0zskuRldj_4n4',
                                          datasource='PostGIS',
                                          frequency=7,
                                          persistent_column='K',
                                          excel_filename='[RSA] Ontbrekende gegevens installaties V&W-WW.xlsx')
