    ...
    def init_report(self):
        ...
        self.report.result_query = """
            ...
            relaties_met_ips AS (
                ...
                FROM n
                    LEFT JOIN assetrelaties ar ON n.uuid = ar.bronuuid AND ar.relatietype = '812dd4f3-c34e-43d1-88f1-3bcd0b1e89c2'
                    LEFT JOIN assets ON ar.doeluuid = assets.uuid AND assets.actief = TRUE AND assets.assettype = '5454b9b1-1bf4-4096-a124-1e3aeee725a2' 
                GROUP BY 1)
