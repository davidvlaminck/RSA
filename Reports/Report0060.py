...
class Report0060:
    ...
    def init_report(self):
        ...
        self.report.result_query = """
            ...
            RETURN x.uuid as uuid, x.naampad as naampad, x.toestand as toestand, x.`tz:toezichter.tz:voornaam` as tz_voornaam, x.`tz:toezichter.tz:naam` as tz_naam, x.`tz:toezichter.tz:email` as tz_email
            UNION 
            MATCH (x:Asset{isActief: True})-[:HoortBij]-(y{isActief: True}) 
