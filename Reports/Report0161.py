...
class Report0161(BaseReport):
    def init_report(self) -> None:
        self.report = DQReport(name='report0161',
        ...
        records AS ( 
            ...
            WHERE assets.actief = TRUE AND assettypes.uri NOT LIKE 'https://grp%' AND assettypes.uri NOT LIKE 'https://wegen%' AND toezichtgroepen.referentie = 'EMT_BMI' ) 
        SELECT *
        FROM records
